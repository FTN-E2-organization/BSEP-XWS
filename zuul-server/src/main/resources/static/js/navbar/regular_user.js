$(document).ready(function () {
    $('body').prepend($(
        ...
        + '  </li>'
        + '  <li class="nav-item">'
        + '  <a class="nav-link .text-dark" href="likedPosts.html" style="color:black;">My likes</a>'
        + '  </li>'
        + '  <li class="nav-item">'
        + '  <a class="nav-link .text-dark" href="dislikedPosts.html" style="color:black;">My dislikes</a>'
        + '  </li>'
