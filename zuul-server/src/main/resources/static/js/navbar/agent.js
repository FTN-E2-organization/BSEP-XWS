$(document).ready(function () {
    $('body').prepend($(
        ...
        + '	 <a class="nav-link .text-dark" style="color:black;" dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Messages</a>'
        + '	 <div class="dropdown-menu" aria-labelledby="navbarDropdown">'
        + '	 <a class="dropdown-item" href="messages.html">Chat</a>'
        + '	 <a class="dropdown-item" href="messageRequests.html">Requests</a></div></li>'
        + '	 <li class="nav-item dropdown">'
