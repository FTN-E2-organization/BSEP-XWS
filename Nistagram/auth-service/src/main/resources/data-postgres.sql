...
INSERT INTO admin (id, username, email, password, salt, is_blocked) VALUES 
			(nextval('users_seq'), 'admin', 'dcarapic1998@gmail.com', '$2a$12$hUyaJlrEqZzHCl19qkHKUOA/C9Z4.fLIuft46tmGqkbM3NH6w6nPa','cb117ff4',false) on conflict (username) do nothing;
