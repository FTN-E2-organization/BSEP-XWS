...
insert into post (id, profile_id, description, location_id) VALUES (nextval('post_seq'), 2, 'Post_example2', 11);
insert into post (id, profile_id, description, location_id) VALUES (nextval('post_seq'), 2, 'Post_example3', 11);
...
insert into favourite_post (id, owner_id, post_id, collection_id) VALUES (12, 1, 1, 6);
insert into favourite_post (id, owner_id, post_id, collection_id) VALUES (11, 1, 2, 5);
